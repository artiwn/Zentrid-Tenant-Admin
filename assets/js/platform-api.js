...
const ZentridPlatformAPI = (() => {
    ...
    async function mutationRequest(path, options, entities, action) {
        const result = await ZentridAPI.request(path, options);
        const detail = {
            action,
            path,
        ...
        window.dispatchEvent(new CustomEvent('zentrid:data-mutated', { detail }));
        return result;
    }
    ...
    function collectionCount(value, depth = 0) {
        if (depth > 5)
            return null;
    ...
    async function exportCsv(path, fallbackPrefix) {
        ...
        const response = await fetch(`${ZentridAPI.config.apiBaseUrl}${path}`, { method: 'GET', headers });
        if (!response.ok)
            throw new Error(`Unable to export alerts (${response.status})`);
    ...
    const live = {
        plants: (options = {}) => ZentridAPI.request('/api/plants', options),
        devices: (options = {}) => ZentridAPI.request('/api/devices', options),
        alerts: (options = {}) => ZentridAPI.request('/api/alerts', options),
        integrations: (options = {}) => ZentridAPI.request('/api/integrations', options),
        providers: (options = {}) => ZentridAPI.request('/api/Providers', options),
        telemetry: (options = {}) => FleetAPI.request('/api/telemetry', options)
    };
    const liveDevices = {
        list: (query = {}, options = {}) => ZentridAPI.request(`/api/devices${qs(query)}`, options),
        get: (id, options = {}) => ZentridAPI.request(`/api/devices/${encodeURIComponent(id)}`, options),
        connectivity: (id, options = {}) => ZentridAPI.request(`/api/devices/${encodeURIComponent(id)}/connectivity`, options),
        network: (id, options = {}) => ZentridAPI.request(`/api/devices/${encodeURIComponent(id)}/network`, options),
        warranty: (id, options = {}) => ZentridAPI.request(`/api/devices/${encodeURIComponent(id)}/warranty`, options),
        telemetryLatest: (id, options = {}) => ZentridAPI.request(`/api/devices/${encodeURIComponent(id)}/telemetry/latest`, options)
    };
    const liveAlerts = {
        list: (options = {}) => ZentridAPI.request('/api/alerts', options),
        get: (id, options = {}) => ZentridAPI.request(`/api/alerts/${encodeURIComponent(id)}`, options),
        exportCsv: (query = {}) => exportCsv(`/api/alerts/export${qs(query)}`, 'alerts-export'),
        acknowledge: (id, payload) => mutationRequest(`/api/alerts/${encodeURIComponent(id)}/acknowledge`, jsonOptions('POST', payload), ['alerts'], 'live-alert.acknowledge'),
        assign: (id, payload) => mutationRequest(`/api/alerts/${encodeURIComponent(id)}/assign`, jsonOptions('POST', payload), ['alerts'], 'live-alert.assign'),
        escalate: (id, payload) => mutationRequest(`/api/alerts/${encodeURIComponent(id)}/escalate`, jsonOptions('POST', payload), ['alerts'], 'live-alert.escalate'),
        resolve: (id, payload) => mutationRequest(`/api/alerts/${encodeURIComponent(id)}/resolve`, jsonOptions('POST', payload), ['alerts'], 'live-alert.resolve'),
        timeline: (id, options = {}) => ZentridAPI.request(`/api/alerts/${encodeURIComponent(id)}/timeline`, options),
        related: (id, options = {}) => ZentridAPI.request(`/api/alerts/${encodeURIComponent(id)}/related`, options),
        telemetryCurve: (id, query = {}, options = {}) => ZentridAPI.request(`/api/alerts/${encodeURIComponent(id)}/telemetry-curve${qs(query)}`, options),
        sop: (id, options = {}) => ZentridAPI.request(`/api/alerts/${encodeURIComponent(id)}/sop`, options),
        updateSop: (id, payload) => mutationRequest(`/api/alerts/${encodeURIComponent(id)}/sop`, jsonOptions('PUT', payload), ['alerts'], 'live-alert.sop.update'),
        createTask: (id, payload = {}) => mutationRequest(`/api/alerts/${encodeURIComponent(id)}/tasks`, jsonOptions('POST', payload), ['alerts'], 'live-alert.task.create')
    };
    const tenants = {
        list: (options = {}) => ZentridAPI.request('/api/admin/tenants', options),
        get: (id, options = {}) => ZentridAPI.request(`/api/admin/tenants/${encodeURIComponent(id)}`, options),
        create: (payload) => mutationRequest('/api/admin/tenants', jsonOptions('POST', payload), ['tenants'], 'tenant.create'),
        update: (id, payload) => mutationRequest(`/api/admin/tenants/${encodeURIComponent(id)}`, jsonOptions('PUT', payload), ['tenants'], 'tenant.update'),
        activate: (id) => mutationRequest(`/api/admin/tenants/${encodeURIComponent(id)}/activate`, { method: 'POST' }, ['tenants'], 'tenant.activate'),
        deactivate: (id) => mutationRequest(`/api/admin/tenants/${encodeURIComponent(id)}/deactivate`, { method: 'POST' }, ['tenants'], 'tenant.deactivate'),
        archive: (id) => mutationRequest(`/api/admin/tenants/${encodeURIComponent(id)}/archive`, { method: 'POST' }, ['tenants'], 'tenant.archive'),
        uploadDocument: (id, payload) => mutationRequest(`/api/admin/tenants/${encodeURIComponent(id)}/documents`, { method: 'POST', body: payload }, ['tenants'], 'tenant.document.upload'),
        getDocument: (id, documentId) => downloadDocument(`/api/admin/tenants/${encodeURIComponent(id)}/documents/${encodeURIComponent(documentId)}`),
        deleteDocument: (id, documentId) => mutationRequest(`/api/admin/tenants/${encodeURIComponent(id)}/documents/${encodeURIComponent(documentId)}`, { method: 'DELETE' }, ['tenants'], 'tenant.document.delete')
    };
    const clients = {
        list: (options = {}) => ZentridAPI.request('/api/admin/clients', options),
        get: (id, options = {}) => ZentridAPI.request(`/api/admin/clients/${encodeURIComponent(id)}`, options),
        create: (payload) => mutationRequest('/api/admin/clients', jsonOptions('POST', payload), ['clients'], 'client.create'),
        update: (id, payload) => mutationRequest(`/api/admin/clients/${encodeURIComponent(id)}`, jsonOptions('PUT', payload), ['clients'], 'client.update'),
        activate: (id) => mutationRequest(`/api/admin/clients/${encodeURIComponent(id)}/activate`, { method: 'POST' }, ['clients'], 'client.activate'),
        deactivate: (id) => mutationRequest(`/api/admin/clients/${encodeURIComponent(id)}/deactivate`, { method: 'POST' }, ['clients'], 'client.deactivate'),
        suspend: (id) => mutationRequest(`/api/admin/clients/${encodeURIComponent(id)}/suspend`, { method: 'POST' }, ['clients'], 'client.suspend'),
        archive: (id) => mutationRequest(`/api/admin/clients/${encodeURIComponent(id)}/archive`, { method: 'POST' }, ['clients'], 'client.archive'),
        uploadDocument: (id, payload) => mutationRequest(`/api/admin/clients/${encodeURIComponent(id)}/documents`, { method: 'POST', body: payload }, ['clients'], 'client.document.upload'),
        getDocument: (id, documentId) => downloadDocument(`/api/admin/clients/${encodeURIComponent(id)}/documents/${encodeURIComponent(documentId)}`),
        deleteDocument: (id, documentId) => mutationRequest(`/api/admin/clients/${encodeURIComponent(id)}/documents/${encodeURIComponent(documentId)}`, { method: 'DELETE' }, ['clients'], 'client.document.delete')
    };
    const plantRegistry = {
        list: (options = {}) => ZentridAPI.request('/api/admin/plants', options),
        search: (search, options = {}) => ZentridAPI.request(`/api/admin/plants?search=${encodeURIComponent(search)}&page=1&pageSize=50`, options),
        get: (id, options = {}) => ZentridAPI.request(`/api/admin/plants/${encodeURIComponent(id)}`, options),
        create: (payload) => mutationRequest('/api/admin/plants', jsonOptions('POST', payload), ['plants'], 'plant.create'),
        update: (id, payload) => mutationRequest(`/api/admin/plants/${encodeURIComponent(id)}`, jsonOptions('PUT', payload), ['plants'], 'plant.update'),
        devices: (plantId, options = {}) => ZentridAPI.request(`/api/admin/plants/${encodeURIComponent(plantId)}/devices`, options),
        createDevice: (plantId, payload) => mutationRequest(`/api/admin/plants/${encodeURIComponent(plantId)}/devices`, jsonOptions('POST', payload), ['plants', 'devices'], 'plant.device.create'),
        activate: (id) => mutationRequest(`/api/admin/plants/${encodeURIComponent(id)}/activate`, { method: 'POST' }, ['plants'], 'plant.activate'),
        deactivate: (id) => mutationRequest(`/api/admin/plants/${encodeURIComponent(id)}/deactivate`, { method: 'POST' }, ['plants'], 'plant.deactivate'),
        archive: (id) => mutationRequest(`/api/admin/plants/${encodeURIComponent(id)}/archive`, { method: 'POST' }, ['plants'], 'plant.archive'),
        uploadDocument: (id, payload) => mutationRequest(`/api/admin/plants/${encodeURIComponent(id)}/documents`, { method: 'POST', body: payload }, ['plants'], 'plant.document.upload'),
        getDocument: (id, documentId) => downloadDocument(`/api/admin/plants/${encodeURIComponent(id)}/documents/${encodeURIComponent(documentId)}`),
        deleteDocument: (id, documentId) => mutationRequest(`/api/admin/plants/${encodeURIComponent(id)}/documents/${encodeURIComponent(documentId)}`, { method: 'DELETE' }, ['plants'], 'plant.document.delete')
    };
    const deviceRegistry = {
        list: (options = {}) => ZentridAPI.request('/api/admin/devices', options),
        get: (id, options = {}) => ZentridAPI.request(`/api/admin/devices/${encodeURIComponent(id)}`, options),
        create: (payload) => mutationRequest('/api/admin/devices', jsonOptions('POST', payload), ['devices'], 'device.create'),
        update: (id, payload) => mutationRequest(`/api/admin/devices/${encodeURIComponent(id)}`, jsonOptions('PUT', payload), ['devices'], 'device.update'),
        audit: (id, options = {}) => ZentridAPI.request(`/api/admin/devices/${encodeURIComponent(id)}/audit`, options),
        linkedDevices: (id, options = {}) => ZentridAPI.request(`/api/admin/devices/${encodeURIComponent(id)}/linked-devices`, options),
        connectivity: (id, options = {}) => ZentridAPI.request(`/api/admin/devices/${encodeURIComponent(id)}/connectivity`, options),
        network: (id, options = {}) => ZentridAPI.request(`/api/admin/devices/${encodeURIComponent(id)}/network`, options),
        warranty: (id, options = {}) => ZentridAPI.request(`/api/admin/devices/${encodeURIComponent(id)}/warranty`, options),
        telemetryLatest: (id, options = {}) => ZentridAPI.request(`/api/admin/devices/${encodeURIComponent(id)}/telemetry/latest`, options),
        command: (id, payload) => mutationRequest(`/api/admin/devices/${encodeURIComponent(id)}/commands`, jsonOptions('POST', payload), ['devices'], 'device.command'),
        activate: (id) => mutationRequest(`/api/admin/devices/${encodeURIComponent(id)}/activate`, { method: 'POST' }, ['devices'], 'device.activate'),
        deactivate: (id) => mutationRequest(`/api/admin/devices/${encodeURIComponent(id)}/deactivate`, { method: 'POST' }, ['devices'], 'device.deactivate'),
        archive: (id) => mutationRequest(`/api/admin/devices/${encodeURIComponent(id)}/archive`, { method: 'POST' }, ['devices'], 'device.archive'),
        uploadDocument: (id, payload) => mutationRequest(`/api/admin/devices/${encodeURIComponent(id)}/documents`, { method: 'POST', body: payload }, ['devices'], 'device.document.upload'),
        getDocument: (id, documentId) => downloadDocument(`/api/admin/devices/${encodeURIComponent(id)}/documents/${encodeURIComponent(documentId)}`),
        deleteDocument: (id, documentId) => mutationRequest(`/api/admin/devices/${encodeURIComponent(id)}/documents/${encodeURIComponent(documentId)}`, { method: 'DELETE' }, ['devices'], 'device.document.delete')
    };
    const adminAlerts = {
        list: (options = {}) => ZentridAPI.request('/api/admin/alerts', options),
        get: (id, options = {}) => ZentridAPI.request(`/api/admin/alerts/${encodeURIComponent(id)}`, options),
        exportCsv: (query = {}) => exportCsv(`/api/admin/alerts/export${qs(query)}`, 'admin-alerts-export'),
        acknowledge: (id, payload) => mutationRequest(`/api/admin/alerts/${encodeURIComponent(id)}/acknowledge`, jsonOptions('POST', payload), ['alerts'], 'alert.acknowledge'),
        assign: (id, payload) => mutationRequest(`/api/admin/alerts/${encodeURIComponent(id)}/assign`, jsonOptions('POST', payload), ['alerts'], 'alert.assign'),
        escalate: (id, payload) => mutationRequest(`/api/admin/alerts/${encodeURIComponent(id)}/escalate`, jsonOptions('POST', payload), ['alerts'], 'alert.escalate'),
        resolve: (id, payload) => mutationRequest(`/api/admin/alerts/${encodeURIComponent(id)}/resolve`, jsonOptions('POST', payload), ['alerts'], 'alert.resolve'),
        timeline: (id, options = {}) => ZentridAPI.request(`/api/admin/alerts/${encodeURIComponent(id)}/timeline`, options),
        related: (id, options = {}) => ZentridAPI.request(`/api/admin/alerts/${encodeURIComponent(id)}/related`, options),
        telemetryCurve: (id, query = {}, options = {}) => ZentridAPI.request(`/api/admin/alerts/${encodeURIComponent(id)}/telemetry-curve${qs(query)}`, options),
        sop: (id, options = {}) => ZentridAPI.request(`/api/admin/alerts/${encodeURIComponent(id)}/sop`, options),
        updateSop: (id, payload) => mutationRequest(`/api/admin/alerts/${encodeURIComponent(id)}/sop`, jsonOptions('PUT', payload), ['alerts'], 'alert.sop.update'),
        createTask: (id, payload = {}) => mutationRequest(`/api/admin/alerts/${encodeURIComponent(id)}/tasks`, jsonOptions('POST', payload), ['alerts'], 'alert.task.create')
    };
    const providerPlantAssignments = {
        list: (options = {}) => ZentridAPI.request('/api/admin/provider-plant-assignments', options)
    };
    const providerIntegrations = {
        templates: () => ZentridAPI.request('/api/admin/provider-integrations/templates'),
        template: (providerType) => ZentridAPI.request(`/api/admin/provider-integrations/templates/${encodeURIComponent(providerType)}`),
        list: (options = {}) => ZentridAPI.request('/api/admin/provider-integrations', options),
        get: (id, options = {}) => ZentridAPI.request(`/api/admin/provider-integrations/${encodeURIComponent(id)}`, options),
        create: (payload) => mutationRequest('/api/admin/provider-integrations', jsonOptions('POST', payload), ['integrations'], 'integration.create'),
        validate: (id) => mutationRequest(`/api/admin/provider-integrations/${encodeURIComponent(id)}/validate`, { method: 'POST' }, ['integrations'], 'integration.validate'),
        testConnection: (id) => mutationRequest(`/api/admin/provider-integrations/${encodeURIComponent(id)}/test-connection`, { method: 'POST' }, ['integrations'], 'integration.test-connection'),
        testSampleData: (id) => mutationRequest(`/api/admin/provider-integrations/${encodeURIComponent(id)}/test-sample-data`, { method: 'POST' }, ['integrations'], 'integration.test-sample-data'),
        activate: (id) => mutationRequest(`/api/admin/provider-integrations/${encodeURIComponent(id)}/activate`, { method: 'POST' }, ['integrations', 'plants', 'devices', 'alerts'], 'integration.activate'),
        suspend: (id) => mutationRequest(`/api/admin/provider-integrations/${encodeURIComponent(id)}/suspend`, { method: 'POST' }, ['integrations', 'plants', 'devices', 'alerts'], 'integration.suspend'),
        archive: (id) => mutationRequest(`/api/admin/provider-integrations/${encodeURIComponent(id)}/archive`, { method: 'POST' }, ['integrations', 'plants', 'devices', 'alerts'], 'integration.archive'),
        failed: (id) => mutationRequest(`/api/admin/provider-integrations/${encodeURIComponent(id)}/failed`, { method: 'POST' }, ['integrations', 'plants', 'devices', 'alerts'], 'integration.failed')
    };
